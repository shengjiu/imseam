 ...
 *       &lt;sequence>
 *         &lt;element name="connector" type="{http://www.imseam.com/}connector-config" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Connectors {
    ...
    protected List<ConnectorConfig> connector;
     ...
     * 
     */
    public List<ConnectorConfig> getConnector() {
        if (connector == null) {
            connector = new ArrayList<ConnectorConfig>();
        }
