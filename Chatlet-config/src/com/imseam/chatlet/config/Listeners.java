 ...
 *       &lt;sequence>
 *         &lt;element name="listener" type="{http://www.imseam.com/}listener-config" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Listeners {
    ...
    protected List<ListenerConfig> listener;
     ...
     * 
     */
    public List<ListenerConfig> getListener() {
        if (listener == null) {
            listener = new ArrayList<ListenerConfig>();
        }
