...
public class IMMeetingContext extends AbstractBoundContext<IAttributes> {
	
	private static final String IDENTIFIER = IMMeetingContext.class.getName();
	 ...
	 * Constructor
	 */
	public IMMeetingContext() {
		super(true);
		this.namingScheme = new SimpleNamingScheme(IMMeetingContext.class.getName());
	}
	
	@Override
    public Class<IMMeetingScoped> getScope() {
        return IMMeetingScoped.class;
    }
	...
	public String toString() {
		...
		return active + "Meeting context " + beanStoreInfo;
	}
