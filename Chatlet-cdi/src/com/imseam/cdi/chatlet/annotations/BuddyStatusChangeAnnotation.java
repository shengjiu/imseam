 ...
 * 
 */
public class BuddyStatusChangeAnnotation extends AbstractChatletEventAnnotation<BuddyStatusChange> implements BuddyStatusChange{

	private static final long serialVersionUID = -3467779839244748221L;

	public BuddyStatusChangeAnnotation() {
	}
