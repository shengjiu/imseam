...
public class ChatFlowPaletteViewer extends PaletteViewer {
	
	private ChatFlowEditor editor;
	
	public ChatFlowPaletteViewer(ChatFlowEditor editor) {
		this.editor = editor;
	}
	...
	private void initEditDomain(SashForm parent) {
		...
		editDomain.setPaletteRoot(new ChatFlowPaletteRoot(editor));
	}
