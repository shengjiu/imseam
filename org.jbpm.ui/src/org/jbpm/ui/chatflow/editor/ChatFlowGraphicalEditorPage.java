 ...
 */
package org.jbpm.ui.chatflow.editor;
...
import org.jbpm.ui.chatflow.outline.ChatFlowOutlineViewer;

public class ChatFlowGraphicalEditorPage extends EditorPart {
	
	private ChatFlowEditor editor;
	private SashForm designerForm;
	private ChatFlowPaletteViewer designerPaletteViewer;
	private ChatFlowModelViewer designerModelViewer;
	private ChatFlowOutlineViewer outlineViewer;

	public ChatFlowGraphicalEditorPage(ChatFlowEditor editor) {
		this.editor = editor;
	}
	...
	private void addOutlineViewer() {
		setOutlineViewer(new ChatFlowOutlineViewer(editor));
	}
	
	private void addModelViewer() {
		setDesignerModelViewer(new ChatFlowModelViewer(editor));
		getDesignerModelViewer().createControl(designerForm);
	}
	
	private void addPaletteViewer() {
		setDesignerPaletteViewer(new ChatFlowPaletteViewer(editor));
	...
	private void initInput(IEditorInput input) throws PartInitException {
		IEditorInput gpdInput = ChatFlowContentProvider.INSTANCE.getGpdEditorInput(input);
		setInput(gpdInput);
		ChatFlowContentProvider.INSTANCE.addGraphicalInfo(editor.getProcessDefinition(), gpdInput);
	}
	
	public ChatFlowModelViewer getDesignerModelViewer() {
		return designerModelViewer;
	}
	

	public void setDesignerModelViewer(ChatFlowModelViewer designerModelViewer) {
		this.designerModelViewer = designerModelViewer;
	}
	

	public ChatFlowPaletteViewer getDesignerPaletteViewer() {
		return designerPaletteViewer;
	}
	

	public void setDesignerPaletteViewer(ChatFlowPaletteViewer designerPaletteViewer) {
		this.designerPaletteViewer = designerPaletteViewer;
	}
	

	public ChatFlowOutlineViewer getOutlineViewer() {
		return outlineViewer;
	}
	

	public void setOutlineViewer(ChatFlowOutlineViewer outlineViewer) {
		this.outlineViewer = outlineViewer;
	}
	
	public ChatFlowEditor getEditor() {
		return editor;
	}
