...
public class ChatFlowEditor extends XMLMultiPageEditorPart {

	private ProcessDefinition processDefinition;

	private StructuredTextEditor sourcePage;

	private ChatFlowGraphicalEditorPage graphPage;
	...
	private ChatFlowActionRegistry actionRegistry;
	...
	public void init(IEditorSite site, IEditorInput input)
		...
		if (fileInput.getName().equals(".jbpm-chatflow.gpi")) {
			fileInput = ChatFlowContentProvider.INSTANCE
	...
	private void initActionRegistry() {
		actionRegistry = new ChatFlowActionRegistry(this);
	}
	...
	public Object getAdapter(Class adapter) {
		Object result = null;
		if (adapter == ChatFlowEditor.class) {
			result = this;
	...
	private void addGraphPage() throws PartInitException {
		graphPage = new ChatFlowGraphicalEditorPage(this);
	...
	public ChatFlowModelViewer getGraphicalViewer() {
	...
	ChatFlowActionRegistry getActionRegistry() {
	...
	public void doSave(IProgressMonitor monitor) {
		...
		ChatFlowContentProvider.INSTANCE.saveToInput(getEditorInput(),
