...
public class ChatFlowContentProvider {

	public static final ChatFlowContentProvider INSTANCE = new ChatFlowContentProvider();
	...
	private void write(
		...
		try {
			...
			Element root = document.addElement("chatflow-diagram");
