...
public class ChatFlowEditorActionBarContributor extends
    ...
    private static final String[] TEXTEDITOR_ACTION_IDS = {
 	...
 	public void setActivePage(IEditorPart activeEditor) {
		...
		if (activeEditor instanceof ChatFlowGraphicalEditorPage) {
			hookGlobalGraphicalEditorActions((ChatFlowGraphicalEditorPage)activeEditor, actionBars);
	...
	private void hookGlobalGraphicalEditorActions(
			ChatFlowGraphicalEditorPage part, IActionBars actionBars) {
