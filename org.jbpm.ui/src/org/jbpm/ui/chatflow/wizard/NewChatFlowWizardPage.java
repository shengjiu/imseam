...
public class NewChatFlowWizardPage extends WizardPage {
	...
	public NewChatFlowWizardPage() {
		super("Chat Flow");
		setTitle("Create Chat Flow");
		setDescription("Create a new chat flow");	
