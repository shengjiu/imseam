...
import org.jbpm.ui.model.NoWaitNode;
...
public class NoWaitNodeContributor implements ElementContributor {

	public Object createElement() {
		return new NoWaitNode();
	}

	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((NoWaitNode)element);
	}
	...
	public IFigure createFigure() {
		return new NodeFigure("NoWaitNode");
	}
}
