...
import org.jbpm.ui.model.NoWaitChatPage;
...
public class NoWaitChatPageContributor implements ElementContributor {

	public Object createElement() {
		return new NoWaitChatPage();
	}

	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((NoWaitChatPage)element);
	}
	...
	public IFigure createFigure() {
		return new NodeFigure("NoWaitChatPage");
	}
}
