...
import org.jbpm.ui.model.ChatPage;
...
public class ChatPageContributor implements ElementContributor {
	...
	public EditPart createGraphicalEditPart(Element element) {
		return new NodeGraphicalEditPart((ChatPage)element);
	}
	...
	public IFigure createFigure() {
		return new NodeFigure("ChatPage");
	}
}
