...
public abstract class DeploymentScanner {
	private static final Log log = LogFactory.getLog(DeploymentScanner.class);

	protected String resourceName;
	protected ClassLoader classLoader;

	public DeploymentScanner(String resourceName) {
		this(resourceName, Thread.currentThread().getContextClassLoader());
	}

	public DeploymentScanner(String resourceName, ClassLoader classLoader) {
	...
	protected String getAnnotationValue(ClassFile cf, Class<? extends Annotation> annotationType, String memberName) {
		...
		if (visible != null) {
			...
			if (annotation == null) {
				...
				return memberValue == null ? null : memberValue.toString(); // TODO:
																			// toString()
																			// here
																			// is
																			// probably
